...
exports.question = function(request, response){
	 response.render('quizes/question', {title: 'Bienvenid@ a Quiz', question: 'Capital de Francia', file: 'quizes/question'});
}

exports.answer = function(request, response){

	var answer = request.query.answer;
	var feedback = answer && answer.toLowerCase() === "paris" ? "Correcto" : "Incorrecto";	
